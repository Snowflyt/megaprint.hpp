  ...
  if constexpr (simple_type<T>) {
    ...
    using possible_types =
        std::tuple<std::nullptr_t, char, signed char, unsigned char, wchar_t, char8_t, char16_t,
                   ...
                   std::u16string_view, std::u32string_view, std::pmr::string, std::pmr::wstring,
                   std::pmr::u8string, std::pmr::u16string, std::pmr::u32string,
                   std::filesystem::path, bool, short, unsigned short, int, unsigned int, long,
                   unsigned long, long long, unsigned long long, std::complex<float>,
                   std::complex<double>, std::complex<long double>, std::any>;
